<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="SettlementList.aspx.cs" Inherits="DXMNCGUI_CARPOOL_SYSTEM.Transactions.Settlement.SettlementList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxPopupControl ID="apcalert" ClientInstanceName="apcalert" runat="server" Modal="True"
        PopupHorizontalAlign="WindowCenter" AutoUpdatePosition="true" ShowCloseButton="true" PopupVerticalAlign="WindowCenter" HeaderText="Alert Error!" AllowDragging="True" PopupAnimationType="Fade" EnableViewState="False" Theme="Office2010Blue">
    </dx:ASPxPopupControl>
    <dx:ASPxPopupControl ID="apcApproval" ClientInstanceName="apcApproval" runat="server" Modal="True" Theme="Office2010Blue" Width="850px"
                                ...
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxGridView 
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn Name="colEmployeeName" Caption="Employee Name" FieldName="BookBy" ReadOnly="True" ShowInCustomizationForm="true" Visible="true" VisibleIndex="3" Width="10%">
                                                <HeaderStyle Font-Bold="true" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Name="colDept" Caption="Department" FieldName="BookDept" ReadOnly="True" ShowInCustomizationForm="true" Visible="true" VisibleIndex="4" Width="10%">
                                                <HeaderStyle Font-Bold="true" />
                                            </dx:GridViewDataTextColumn>
    ...
    <dx:ASPxFormLayout runat="server" ID="FormLayout1" ClientInstanceName="FormLayout1">
        ...
        <Items>
            <dx:LayoutGroup ShowCaption="True" GroupBoxDecoration="HeadingLine" Caption="Settlement List" ColCount="5">
                <GroupBoxStyle>
                    ...
                    <dx:LayoutItem ShowCaption="False" Width="10%">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer4" runat="server">
                                <dx:ASPxButton ID="btnRefresh" ClientInstanceName="btnRefresh" runat="server" Text="Refresh" OnClick="btnRefresh_Click" ToolTip="Click here to reload Booking list" Width="100%" Height="30px" Theme="Office2010Blue">
                                    <Border BorderStyle="Outset" BorderWidth="2" BorderColor="#d0dded"/>
                                </dx:ASPxButton>
                            </dx:LayoutItemNestedControlContainer>
                        </LayoutItemNestedControlCollection>
                            ...
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxGridView
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Name="colBookNo" Caption="Booking No." FieldName="BookNo" ReadOnly="True" ShowInCustomizationForm="true" Visible="true" VisibleIndex="3" Width="10%">
                                            <HeaderStyle Font-Bold="true" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Name="colEmployeeName" Caption="Employee Name" FieldName="BookBy" ReadOnly="True" ShowInCustomizationForm="true" Visible="true" VisibleIndex="4" Width="10%">
                                            <HeaderStyle Font-Bold="true" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Name="colEmployeeCompanyName" Caption="Company Name" FieldName="BookCompany" ReadOnly="True" ShowInCustomizationForm="true" Visible="true" VisibleIndex="5" Width="10%">
                                            <HeaderStyle Font-Bold="true" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataSpinEditColumn Name="colTotal" Caption="Total" FieldName="Total" ReadOnly="true" ShowInCustomizationForm="true" PropertiesSpinEdit-DisplayFormatString="#,0.00" Visible="true" VisibleIndex="6" Width="10%">
                                            <HeaderStyle Font-Bold="true" />
